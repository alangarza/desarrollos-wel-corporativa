...
<div class="featured-properties content-area-2">
    <div class="container">
        ...
        <ul class="list-inline-listing filters filteriz-navigation">
            ...
            <li data-filter="1" class="btn btn-inline filtr-button filtr">Locales</li>
            <li data-filter="2" class="btn btn-inline filtr-button filtr">Oficinas</li>
            <li data-filter="3" class="btn btn-inline filtr-button filtr">Departamentos</li>
        </ul>
