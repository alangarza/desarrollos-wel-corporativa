                    ...
                    <div class="heading-properties">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">
                                    <h3>Torre Vetro</h3>
                                    <p><i class="fa fa-map-marker"></i> Monterrey, Nuevo Leon.</p>
                                </div>
                ...
                <div class="tabbing tabbing-box mb-60">
                    ...
                    <div class="tab-content" id="carTabContent">
                        <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                            ...
                            <p>Arq. Eduardo Andonie / Desarrollos WEL <br>Arq. Mario A. Pérez / MAPSTUDIO Arquitectura
                             </p>
                            ...
                            <div class="property-details">
                                <div class="row">
                                    <div class="col-md-8 col-sm-6">
                                        <ul>
                                            <li>
                                            36 locales comerciales desde 47.8 hasta 117.6 m2. 
                                            </li>
                                            <li>
                                            66 espacios para oficinas desde 47.8 hasta 65.3 m2
                                            </li>
                                            <li>
                                            5 salas de juntas de uso común
                                            </li>
                                            <li>
                                            Penthouse para oficinas de 137 m2
                                            </li>
                                            <li>
                                            7 niveles de estacionamiento, planta baja y 6 sótanos
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="intro-text">
                    <h3>¿Le Interesa Invertir en Torre Vetro?</h3>
                </div>
            </div>
