                ...
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    <div class="heading-properties">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="pull-left">
                                    <h3>Plaza Santa Isabel </h3>
                                    <p><i class="fa fa-map-marker"></i> Saltillo, Coahuila.</p>
                                </div>
                ...
                <div class="tabbing tabbing-box mb-60">
                    ...
                    <div class="tab-content" id="carTabContent">
                        <div class="tab-pane fade active show" id="one" role="tabpanel" aria-labelledby="one-tab">
                            <h3 class="heading">Plaza Santa Isabel</h3>
                            <p>Desde hace algunos años, Saltillo se ha consolidado como una de las principales zonas económicas del país, la llegada de empresas ha aumentado la demanda laboral y esto ha generado un aumento en la población del municipio. Por esto, y por la excelente ubicación y diseño de nuestra plaza Santa Isabel, es una de las mejores inversiones inmobiliarias que puedes hacer.  
                             </p>
                             <hr>
                    ...
                    <ul class="carousel-indicators smail-properties list-inline nav nav-justified ">
                            ...
                            <div class="property-details">
                                <div class="row">
                                    <div class="col-md-8 col-sm-6">
                                        ...
                                        <ul>
                                            <li>
                                            Locales comerciales desde 54.2 m2
                                            </li>
                                            <li>
                                            Locales anclas de 297 hasta 1,585 m2
                                            </li>
                                            <li>
                                            Locales con terraza para restaurantes desde 117 m2
                                            </li>
                                            <li>
                                            Escaleras eléctricas en el área comercial
                                            </li>
                                            <li>
                                            5 elevadores exclusivos para oficinas
                                            </li>
                                            <li>
                                            2 elevadores exclusivos para comercio
                                            </li>
                                            <li>
                                            2 sótanos con más de 850 cajones de estacionamiento
                                            </li><li>
                                            Más de 130 espacios de oficinas
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="tab-pane fade " id="5" role="tabpanel" aria-labelledby="5-tab">
                            <div class="section location">
                                ...
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3602.4044053380267!2d-100.97892418490854!3d25.458168427310273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x868812b46bc706ef%3A0xcd65ab7c25f9be19!2sPlaza+Santa+Isabel!5e0!3m2!1sen!2smx!4v1541445323300" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-12">
                <div class="intro-text">
                    <h3>¿Le Interesa Invertir en Plaza Santa Isabel?</h3>
                </div>
            </div>
